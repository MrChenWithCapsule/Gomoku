...
constexpr std::pair<Pattern, int> line_score[] = {
    {" o"_c, 17},       {" x"_c, -12},          {"  o"_c, 17},
    {"  x"_c, -12},     {"   o"_c, 17},         {"   x"_c, -12},
    {" o x"_c, 17},     {" x o"_c, -12},        {"  ox"_c, 15},
    {"  xo"_c, -10},    {" o  x"_c, 19},        {" x  o"_c, -14},
    {"  o x"_c, 17},    {"  x o"_c, -12},       {"   ox"_c, 15},
    {"   xo"_c, -10},   {" o   "_c, 21},        {" x   "_c, -16},
    {"  o  "_c, 19},    {"  x  "_c, -14},       {"   o "_c, 17},
    {"   x "_c, -12},   {"    o"_c, 15},        {"    x"_c, -10},
    {" o o"_c, 65},     {" x x"_c, -60},        {" oo "_c, 65},
    {" xx "_c, -60},    {" oo"_c, 65},          {" xx"_c, -60},
    {"  oo"_c, 65},     {"  xx"_c, -60},        {" o ox"_c, 65},
    {" x xo"_c, -60},   {" oo x"_c, 65},        {" xx o"_c, -60},
    {"  oox"_c, 65},    {"  xxo"_c, -60},       {" o o "_c, 75},
    {" x x "_c, -70},   {" oo  "_c, 75},        {" xx  "_c, -70},
    {"  oo "_c, 75},    {"  xx "_c, -70},       {"   oo"_c, 75},
    {"   xx"_c, -70},   {" ooo"_c, 150},        {" xxx"_c, -140},
    {" ooox"_c, 150},   {" xxxo"_c, -140},      {" oo o"_c, 1000},
    {" xx x"_c, -800},  {" o oo"_c, 1000},      {" x xx"_c, -800},
    {" ooo "_c, 1000},  {" xxx "_c, -800},      {" oooo"_c, 3000},
    {" xxxx"_c, -3500}, {"ooooo"_c, first_win}, {"xxxxx"_c, second_win}};
...
{
    std::array scores{match(broad, pos, {1, 0}),  match(broad, pos, {1, 1}),
                      match(broad, pos, {0, 1}),  match(broad, pos, {-1, 1}),
                      match(broad, pos, {-1, 0}), match(broad, pos, {-1, -1}),
                      match(broad, pos, {0, -1}), match(broad, pos, {1, -1})};
    for (auto s : scores)
